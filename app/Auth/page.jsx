...
const LoginPage = () => {
    ...
    async function handleLogin(event) {
        ...
        setLoading(true)
        var reques = await fetch(`http://198:2000/login/auth`, { method: 'POST', headers: { 'Accept': '*/*', 'Content-type': 'application/json' }, body: JSON.stringify({ username: uname.current.value, password: pass.current.value }) })
